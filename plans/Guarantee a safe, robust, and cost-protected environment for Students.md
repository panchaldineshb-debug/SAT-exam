...
Address the critical infrastructure and backend security items from the Final Release Checklist to guarantee a safe, robust, and cost-protected environment for Student.
...
- **Benefit:** If Student accidentally deletes data or a bug corrupts progress, we can restore the database to any second in the last 35 days.
...
- **Benefit:** The UI won't crash or show a generic API error; Student gets a friendly, actionable message.
